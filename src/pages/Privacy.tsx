  ...
  return (
    <>
      ...
      <section className="container-ed pt-12 md:pt-24 pb-10 md:pb-16 relative overflow-hidden">
        <div className="absolute -top-24 -left-40 w-[480px] h-[480px] rounded-full bg-sage-500/10 dark:bg-sage-500/6 blur-3xl -z-10" />
        <div className="max-w-3xl">
          <p className="eyebrow mb-5 animate-fade-in">{privacyPage.eyebrow}</p>
